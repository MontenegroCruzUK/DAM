...
public class COrdenador {
	...
	/**
	 * Apaga el ordenador si está encendido, de lo contrario no hace nada.
	 * Si el ordenador se apaga, cambia el valor del atributo ordenadorEncendido a false.
	 * Imprime un mensaje indicando si el ordenador se ha apagado o si ya estaba apagado.
	 */
